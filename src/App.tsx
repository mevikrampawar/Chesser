...
export default function App() {
  ...
  return (
    <div className={theme === 'dark' ? 'dark' : ''}>
      <div className="min-h-screen bg-gray-950 text-white dark:bg-gray-950 light:bg-gray-50 light:text-gray-900 transition-colors">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6">
          <header className="flex items-center justify-between mb-4 sm:mb-6">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              <button
                ...
                className="bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 disabled:opacity-30 disabled:cursor-not-allowed text-gray-900 dark:text-white text-xs sm:text-sm py-1.5 sm:py-2 px-2 sm:px-3 rounded-lg transition-colors"
              >
              ...
              {user && (
                <div className="flex items-center gap-1.5 sm:gap-2">
                  ...
                  <button
                    ...
                    className="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 text-xs hidden sm:block"
                  >
                    Sign Out
                  </button>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="lg:col-span-2 space-y-3 sm:space-y-4">
              ...
              <div className="bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-3 sm:p-4">
